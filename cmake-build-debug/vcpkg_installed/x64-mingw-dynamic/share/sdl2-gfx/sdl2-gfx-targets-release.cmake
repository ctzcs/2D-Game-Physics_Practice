...
set_target_properties(SDL2::SDL2_gfx PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libSDL2_gfx.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "SDL2::SDL2"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libSDL2_gfx.dll"
  )

list(APPEND _cmake_import_check_targets SDL2::SDL2_gfx )
list(APPEND _cmake_import_check_files_for_SDL2::SDL2_gfx "${_IMPORT_PREFIX}/lib/libSDL2_gfx.dll.a" "${_IMPORT_PREFIX}/bin/libSDL2_gfx.dll" )
